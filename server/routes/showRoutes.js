...
// getting all shows by theatre
router.get('/get-all-shows-by-theatre',  async (req, res) => { // changed the post method to get method
    try{
...
// Deleting a show
router.delete('/delete-show', async (req, res) => { // changed the post method to delete method
    try{
...
router.get("/get-all-theatres-by-movie", async (req, res) => {
    try{
...
// getting shows by id
router.get('/get-show-by-id',  async (req, res) => {
    try{
